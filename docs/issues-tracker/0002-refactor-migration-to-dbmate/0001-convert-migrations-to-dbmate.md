...
2. Converting existing migrations 001 and 002 to dbmate SQL format (with `-- migrate:up` and `-- migrate:down` sections)
...
- [ ] `migrations/20260621120000_0001_promo_codes.sql` exists with correct up/down SQL
- [ ] `migrations/20260621120001_0002_llm_usage_log.sql` exists with correct up/down SQL
- [ ] `package.json` includes scripts: `db:migrate`, `db:rollback`, `db:new`, `db:dump`
- [ ] Old migration files are removed: `001_promo_codes_up.js`, `001_promo_codes_down.js`, `001_promo_codes_seed.js`, `002_llm_usage_log_up.js`, `002_llm_usage_log_down.js`
